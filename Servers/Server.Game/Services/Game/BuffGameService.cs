...
namespace Server.Game.Services.GameServices
{
    ...
    public class BuffGameService : IHostedService
    {
        ...
        private void BuffEnd()
        {
            ...
            //        try
            //        {
            //            var characters = _identificationService.GetAllConnections().Where(c => c.Pc != null).Select(c => c.Pc);
            ...
            //                    {
            //                        var client = _identificationService.GetConnectionByCharacterName(character.NickName);
            ...
            //                        foreach (var visibleCharacters in client.Pc.VisibleCharacterGames)
            //                        {
            //                            _characteristicFactory.SendAbnormalRemove(client, client, buff.Type);
