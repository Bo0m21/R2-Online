...
namespace Server.Game.Core.Systems
{
    public class AttackSystem
    {
        ...
        /// <returns></returns>
        public TypeHit AttackCharacterToCharacter(CharacterGameModel characterGameModel, CharacterGameModel characterAttackedGameModel)
        {
        ...
        /// <returns></returns>
        public TypeHit AttackCharacterToUnit(CharacterGameModel characterGameModel, UnitGameModel unitGameModel)
        {
        ...
        /// <param name="characterGameModel"></param>
        /// <returns></returns>
        public TypeHit AttackUnitToCharacter(UnitGameModel unitGameModel, CharacterGameModel characterGameModel)
        {
            if (unitGameModel.Type == Database.Balance.Enums.UnitType.Npc)
            {
                return TypeHit.Miss;
            }
