...
namespace Server.Game.Core.Factories
{
    ...
    {
        public void SendAttacked(GameSession client, UniqueIdentifier offenceId, UniqueIdentifier defenseId, TypeHit typeHit, Vector3 position, short hpAttacked)
        {
        ...
        public void SendEndAttack(GameSession client, UniqueIdentifier offenceId)
        {
        ...
        public void SendDeadAttack(GameSession client, UniqueIdentifier offenceId, UniqueIdentifier defenseId, int chaotic, ChaoticStatusType chaoticStatus)
        {
