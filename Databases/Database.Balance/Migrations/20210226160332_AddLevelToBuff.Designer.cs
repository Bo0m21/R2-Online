...
namespace Database.Balance.Migrations
{
    ...
    [Migration("20210226160332_AddLevelToBuff")]
    partial class AddLevelToBuff
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Balance.Models.BuffItemModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Database.Balance.Models.BuffModel", b =>
                {
                    ...
                    b.Property<short>("IncDrop")
                        .HasColumnType("smallint");

                    b.Property<short>("IncExp")
                        .HasColumnType("smallint");

                    b.Property<short>("IncSilver")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("Database.Balance.Models.UnitModel", b =>
                {
                    ...
                    b.Property<bool>("IsAggressionInvisible")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Database.Balance.Models.BuffItemModel", b =>
                {
                    b.HasOne("Database.Balance.Models.BuffModel", "Buff")
                        .WithMany("BuffItems")
            ...
            modelBuilder.Entity("Database.Balance.Models.ItemReinforceModel", b =>
                {
                    ...
                    b.Navigation("ItemNew");

                    b.Navigation("ItemOld");
                });
            ...
            modelBuilder.Entity("Database.Balance.Models.ItemModel", b =>
                {
                    ...
                    b.Navigation("ItemReinforceNews");

                    b.Navigation("ItemReinforceOlds");

                    b.Navigation("ItemReinforces");

                    b.Navigation("ItemReinforces1");

                    b.Navigation("ItemReinforces2");

                    b.Navigation("ItemReinforces3");

                    b.Navigation("UnitDrops");

                    b.Navigation("UnitPurchases");

                    b.Navigation("UnitSales");
                });
